...
type ViewFundingProps = ReturnType< typeof mapStateToProps> & typeof mapDispatchToProps;

const ViewAllFunding: React.FC<ViewFundingProps> = ({...props}) => {
    return (
        <div className="main-content-wrapper">
            ...
            <h4 className="mt-24">Funding List</h4>
...
export default connect(mapStateToProps, mapDispatchToProps)(ViewAllFunding);